...
"Mathematical notation in REDCap online data collection instruments"
[[1](#references)]. That article discusses rendering LaTeX mathematical
notation as images in REDCap [[2](#references), [3](#references)] online
surveys. An example survey is provided, using questions drawn from a study of
students' perceptions of physico-mathematical concepts [[4](#references)].

---

<figure>
  <img src="assets/redcap-survey-with-mathematical-notation.png" alt="Browser-based survey questions with mathematical notation such as fractions, Greek letters, subscripts and superscripts." width="532">
...
| Software                       | Notes                                                                                                                                                                                                                                 |
| :----------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| LuaLaTeX                       | [Available here](https://www.latex-project.org). Free in major TeX distributions.                                                                                                                                                     |
| PowerShell<br>&nbsp;<br>&nbsp; | Free.<br>&nbsp;&nbsp;&nbsp;Linux, macOS: [available here](https://learn.microsoft.com/en-us/powershell/scripting/install/install-powershell).<br>&nbsp;&nbsp;&nbsp;Windows: included in Windows 7 and Windows Server 2008 R2 onwards. |
...
| pdftocairo<br>&nbsp;<br>&nbsp; | Free.<br>&nbsp;&nbsp;&nbsp;Linux, macOS: available in poppler-utils.<br>&nbsp;&nbsp;&nbsp;Windows: available in poppler-utils or the MiKTeX package miktex-poppler-bin.                                                               |
...
Conversion of LuaLaTeX-output PDF files to SVG files has been tested with
pdftocairo.

### 3. REDCap Instrument

Import of the instrument file has been tested with REDCap, accessed via a
browser. Successful online rendering of the data collection instrument (a
...
| :--------------- | :----------------- | :------------------------------------- |
| Platform         | Operating system   | Windows 11, 25H2 (OS Build 26200.9445) |
...
This repository used Google Gemini [[5](#references)] as an assistive tool to
...
1. T. Stenborg, "Mathematical notation in REDCap online data collection
   instruments", _TUGboat_, vol. 47, no. 1, pp. 89&ndash;90, Apr. 2026, doi:
   10.47397/tb/47-1/tb145stenborg-redcap.\
   [View PDF](https://tug.org/TUGboat/tb47-1/tb145stenborg-redcap.pdf) &nbsp;
...
2. P. A. Harris, R. Taylor, R. Thielke, J. Payne, N. Gonzalez and J. G. Conde,
   ...
   informatics support", _J. Biomed. Inform._, vol. 42, no. 2, pp.
   377&ndash;381, Apr. 2009, doi: 10.1016/j.jbi.2008.08.010.\
...
3. P. A. Harris et al., "The REDCap consortium: Building an international
   community of software platform partners", _J. Biomed. Inform._, vol. 95,
   Jul. 2019, Art. no. 103208, doi: 10.1016/j.jbi.2019.103208.\
...
4. K. P. Mwangala, and O. Shumba, "Physico-mathematical Conceptual Difficulties
   among First Year Students Learning Introductory University Physics", _Am. J.
   Educ. Res._, vol. 4, no. 17, pp. 1238&ndash;1244, Nov. 2016.\
   [View at publisher](https://www.sciepub.com/EDUCATION/abstract/6712) &nbsp;
   [SciX](https://scixplorer.org/abs/2016AJEdR...4.1238K/abstract)

5. _Google Gemini_. (Large language model, May 2026 release). Google.
